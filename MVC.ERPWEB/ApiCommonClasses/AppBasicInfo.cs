namespace MVC.ERPWEB.ApiCommonClasses
{
    public static class AppBasicInfo
    {
        ...
        public static string usrid1a = "sa"; // "db_a9e723_liveerpdp1_admin";
        public static string usrpass1a = "1234"; //"aspnetbd@321";
        ...
        {
            AppBasicInfo.GerpApiClient.BaseAddress = new Uri("http://localhost:37380/api/");
