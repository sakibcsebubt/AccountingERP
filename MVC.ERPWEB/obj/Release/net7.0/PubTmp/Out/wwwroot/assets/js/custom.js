...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    ...
    toastr.success("Welcome to Admin(SH) Dashboard", "Yeap!");
  }
  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Welcome to DashBoard", " Info message");
      } else if (thisId === "toaster-success") {
          toastr.success("Welcome to DashBoard", "Success message");
      } else if (thisId === "toaster-warning") {
          toastr.warning("Welcome to DashBoard", "Warning message");
      } else if (thisId === "toaster-danger") {
          toastr.error("Welcome to DashBoard", "Danger message");
      }
    });
  }
